...
public class RegisterStudents {
	...
	public Response registerPayment() throws UserRequestExceptionMapper, UnAuthorizedExceptionMapper
	{
    	...
    	String universityAccronym = httpHeader.getHeaderString("universityCode");
    	
    	if(universityAccronym == null)
		{
			throw new UnAuthorizedExceptionMapper("universityAccronym is required");
		
    	}
    	
    	String academicYear = httpHeader.getHeaderString("academicYear");
    	
    	if(academicYear == null)
		{
			throw new UnAuthorizedExceptionMapper("academicYear is required");
							...
							while(parser.hasNext())
							{
								...
								if(event == JsonParser.Event.START_OBJECT)
								{
									 ...
									 if(isStudentRegistered != null )
									 {
										 ...
										 Institution institution = studentAccountDAO.getInstitution(universityAccronym.trim());
										 InstitutionCalender institutionCalender = studentAccountDAO.getInstitutionCalender(academicYear.trim(),institution.getId());
